...
class _ConversationScreenState extends State<ConversationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Tin nhắn', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black)),
        backgroundColor: Colors.white,
        elevation: 0,
      ),
              ...
              return SizeTransition(
                ...
                child: ListTile(
                  ...
                  leading: CircleAvatar(
                    radius: 26,
                    backgroundImage: NetworkImage(conv.avatarUrl ?? 'https://ui-avatars.com/api/?name=${conv.fullname ?? 'U'}'),
                  ),
                  title: Text(
                  ...
                  trailing: Column(
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: 12, 
                          color: conv.unreadCount > 0 ? const Color(0xFFF5A623) : Colors.grey
                        ),
                      ),
